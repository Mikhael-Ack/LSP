...
<svg {{ $attributes->merge(['class' => $class]) }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
    @switch($name)
        {{-- Heroicons: Building Storefront / Shop --}}
        @case('shop')
        @case('building-storefront')
            <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 21v-7.5a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349M3.75 21V9.349m0 0a3.001 3.001 0 0 0 3.75-.615A2.993 2.993 0 0 0 9.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 0 0 2.25 1.016c.896 0 1.7-.393 2.25-1.015a3.001 3.001 0 0 0 3.75.614m-16.5 0a3.004 3.004 0 0 1-.621-4.72l1.189-1.19A1.5 1.5 0 0 1 5.378 3h13.243a1.5 1.5 0 0 1 1.06.44l1.19 1.189a3 3 0 0 1-.621 4.72m-13.5 8.651h3.75a.75.75 0 0 0 .75-.75V13.5a.75.75 0 0 0-.75-.75H5.25a.75.75 0 0 0-.75.75v2.25c0 .414.336.75.75.75Z" />
            @break

        {{-- Heroicons: Receipt / Document Text --}}
        @case('receipt')
        @case('receipt-percent')
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 14.25l6-6m4.5-3.75l-1.5 1.5-1.5-1.5-1.5 1.5-1.5-1.5-1.5 1.5-1.5-1.5-1.5 1.5-1.5-1.5-1.5 1.5-1.5-1.5v16.5l1.5-1.5 1.5 1.5 1.5-1.5 1.5 1.5 1.5-1.5 1.5 1.5 1.5-1.5 1.5 1.5 1.5-1.5 1.5 1.5V3.75zM10.5 8.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0zm4.5 6a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0z" />
            @break

        {{-- Heroicons: Cube / Stock --}}
        @case('cube')
        @case('box')
            <path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
            @break

        {{-- Heroicons: Chart Bar / Analytics --}}
        @case('chart-bar')
        ...
        {{-- Heroicons: Arrow Path (Switch Role) --}}
        @case('arrow-path')
        @case('refresh')
        ...
        {{-- Heroicons: Banknotes (Cash) --}}
        @case('banknotes')
        @case('cash')
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6H2.25m0 0v8.25m0-8.25a60.07 60.07 0 0 1 15.797-2.101c.727-.198 1.453.342 1.453 1.096V6m0 0v1.5m0-1.5a60.07 60.07 0 0 1 1.5 2.25m0 0v8.25m0-8.25A60.07 60.07 0 0 1 21 12m-3-6a60.07 60.07 0 0 0-1.5 2.25M12 12.75a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5z" />
            @break

        {{-- Heroicons: Credit Card --}}
        @case('credit-card')
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-6.75 3.75h16.5a2.25 2.25 0 0 0 2.25-2.25V6.75a2.25 2.25 0 0 0-2.25-2.25H3.75A2.25 2.25 0 0 0 1.5 6.75v10.5a2.25 2.25 0 0 0 2.25 2.25z" />
            @break

        {{-- Heroicons: Squares 2x2 (Grid/Semua) --}}
        @case('squares-2x2')
        @case('grid')
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25zM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25z" />
            @break

        {{-- Heroicons: Fire (Makanan Utama) --}}
        @case('fire')
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48z" />
            @break

        {{-- Heroicons: Sparkles (Appetizer) --}}
        @case('sparkles')
        ...
        {{-- Heroicons: Trophy --}}
        @case('trophy')
            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.504-1.125-1.125-1.125h-6.75c-.621 0-1.125.504-1.125 1.125v3.375m9 0H7.5m9-11.25h3a2.25 2.25 0 0 1 2.25 2.25v1.5a3.75 3.75 0 0 1-3.75 3.75H16.5M7.5 7.5h-3A2.25 2.25 0 0 0 2.25 9.75v1.5a3.75 3.75 0 0 0 3.75 3.75H7.5m9-7.5V4.5A2.25 2.25 0 0 0 14.25 2.25h-4.5A2.25 2.25 0 0 0 7.5 4.5v3m9 0H7.5" />
            @break
        ...
        {{-- Heroicons: Adjustments Horizontal / Sliders --}}
